...
export const SERVICES = [
  ...
  },
  {
    ...
    icon: '🏢',
    subtitle: '商业空间设计',
    description: '专业的商业空间设计服务，为办公、商业、餐饮等场所提供专业的装修设计方案。注重功能性与美观性的完美结合，提升品牌形象和用户体验。',
  ...
  },
  {
    ...
    image: '/src/assets/images/services/4.jpg',
    features: [
      '色彩搭配方案',
      '家具选配指导',
      '装饰品搭配',
  ...
  },
  {
    ...
    image: '/src/assets/images/services/5.jpg',
    features: [
      '庭院景观设计',
      '植物配置方案',
      '水景设计施工',
  ...
  },
  {
    ...
    icon: '🔧',
    subtitle: '专业施工服务',
    description: '专业的装修施工服务，拥有经验丰富的施工团队和严格的质量管理体系。从基础施工到精装修，我们确保每一个细节都达到最高标准。',
    image: '/src/assets/images/services/3.jpg',
    features: [
      '专业施工团队',
      '质量监控体系',
